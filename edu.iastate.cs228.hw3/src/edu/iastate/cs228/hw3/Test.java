...
public class Test {
    public static void main(String args[]) {
        ...
        stoutList.add(2, "Z"); // add at position 2, perform split operation and move Y and X to n'
        System.out.println(stoutList.toStringInternal());
        ...
        stoutList.remove(5); // remove E, no merge should occur since it was in last node and last node doesn't need M/2 elements
        System.out.println(stoutList.toStringInternal());
        System.out.println("Figure 13 - After removing E (no merge with predecessor node)\n");

        stoutList.remove(3); // remove C, full merge should occur to ensure all nodes that aren't last node have at least M/2 elements
        System.out.println(stoutList.toStringInternal());
        System.out.println("Figure 14 - After removing C (full merge with successor node)\n");
