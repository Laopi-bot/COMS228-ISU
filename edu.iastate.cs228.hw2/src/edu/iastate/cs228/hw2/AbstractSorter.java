...
public abstract class AbstractSorter
{
	...
	{
		//set XorY variable in point class when given order
		if(order == 0) {
			Point.setXorY(true);
		}
		else if(order == 1) {
			...
			IllegalArgumentException e = new IllegalArgumentException("Order < 0 or Order > 1");
			throw e;
		}
		
		//create new Comparator class instance
		pointComparator = new ComparingThings();
	}
